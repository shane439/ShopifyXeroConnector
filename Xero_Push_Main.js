...
// }
// function XL_healthcheck_() {
//   var msgs = [];
//   // Manifest-ish sanity (best-effort)
//   try {
//     UrlFetchApp.fetch('https://example.com', {muteHttpExceptions:true}); // proves external_request
//     msgs.push('UrlFetch: OK');
//   } catch (e) { msgs.push('UrlFetch: FAIL → ' + e.message); }

//   // Shopify base
//   try {
//     var b = S_shopifyBase_(); // throws if SHOPIFY_* missing/invalid
//     msgs.push('Shopify base: OK (' + b.dom + ' / ' + b.ver + ')');
//   } catch (e) { msgs.push('Shopify base: FAIL → ' + e.message); }

//   // Shopify reachability (cheap)
//   try {
//     var cfg = S_shopifyBase_();
//     var res = UrlFetchApp.fetch(cfg.base + '/shop.json', {
//       method: 'get',
//       muteHttpExceptions: true,
//       headers: {'X-Shopify-Access-Token': cfg.token}
//     });
//     msgs.push('/shop.json: HTTP ' + res.getResponseCode());
//   } catch (e) { msgs.push('/shop.json: FAIL → ' + e.message); }

//   // Xero token + tenant
//   try {
//     var tok = XL_getAccessToken_(); // throws if refresh fails
//     var tenant = XL_ensureTenantId_(tok);
//     msgs.push('Xero: token & tenant OK (' + tenant + ')');
//   } catch (e) { msgs.push('Xero: FAIL → ' + e.message); }
